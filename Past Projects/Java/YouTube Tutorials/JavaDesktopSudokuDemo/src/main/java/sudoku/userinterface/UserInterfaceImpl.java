...
public class UserInterfaceImpl implements IUserInterfaceContract.View, EventHandler<KeyEvent> {
    ...
    private static final double WINDOW_Y = 732.0;
    private static final double WINDOW_X = 668.0;
    private static final double BOARD_PADDING = 50.0;
    private static final double BOARD_X_AND_Y = 576.0;
